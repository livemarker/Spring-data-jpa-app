...
import task29.DAO.repositories.shopDAO.ShopDAOCategoryRepository;
import task29.entity.CategoryProducts;
import task29.entity.Product;
import task29.DAO.repositories.shopDAO.ShopDAOProductRepository;
...
public class ShopDAO implements ShopDAOInterface {
    ...
    public void delOneProduct(int id) {
        shopDAOProductRepository.deleteById(id);
    }

    @Transactional
    @Modifying
    public void updateOneProduct(Product product) {
        shopDAOProductRepository.save(product);
    }
